...
adminRouter.get('/retrive/all', authentication(ENUM_USER_ROLE.ADMIN,ENUM_USER_ROLE.SUPER_ADMIN),adminControllers.getAllAdmin);
adminRouter.get('/retrive/:id',authentication(ENUM_USER_ROLE.ADMIN,ENUM_USER_ROLE.SUPER_ADMIN), adminControllers.getSpecificAdmin);
